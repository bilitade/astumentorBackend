                ...
                @csrf
                        ...
                        <div class="col-sm-12">
                          ...
                          <div class="form-group">
                            ...
                            <textarea class="form-control" id="validationCustom01" name="description" placeholder="school ...." required=""> {{ old('description', isset($school) ? $school[0]->description : '') }}</textarea>
                            <div class="valid-feedback">Looks good!</div>
                          </div>
                          <div class="form-group">
                            <label for="validationCustom01">VM:</label>
                            <textarea class="form-control" id="validationCustom01" name="vm" value=" {{ old('vm', isset($school) ? $school[0]->vm : '') }}" placeholder="school ...." required=""></textarea>
                            <div class="valid-feedback">Looks good!</div>
                          </div>
                        </div>
