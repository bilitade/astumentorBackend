                ...
                @csrf
                        ...
                        <div class="col-sm-12">
                          ...
                          <div class="form-group">
                            ...
                            <textarea class="form-control" id="validationCustom01" name="description"   placeholder="Department ...." required=""> {{ old('description', isset($department) ? $department[0]->description : '') }}</textarea>
                            <div class="valid-feedback">Looks good!</div>
                          </div>
                          <div class="form-group">
                            <label for="validationCustom01">objective:</label>
                            <textarea class="form-control" id="validationCustom01" name="objective"  placeholder="Department ...." required=""> {{ old('objective', isset($department) ? $department[0]->objective : '') }}</textarea>
                            <div class="valid-feedback">Looks good!</div>
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <select name="school_id" class="js-example-placeholder-multiple col-sm-12" >
                            ...
                            <option value="{{ $item->id }}" @if(old('school_id') == $department[0]->school_id)  {{ 'selected' }}  @endif >{{ $item->name }}</option>
