            ...
            <div class="main-navbar">
              ...
              <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                  ...
                  <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="inbox"></i><span>Group</span></a>
                    <ul class="nav-submenu menu-content">
                        <li> <a href="{{ route('groups.index') }}">Group</a></li>
                        <li> <a href="/groups/join">Discover Group</a></li>
                        <li> <a href="{{ route('groups.create') }}">Group Create</a></li>
