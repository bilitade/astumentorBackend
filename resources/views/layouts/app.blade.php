            ...
            <div class="main-navbar">
              ...
              <div id="mainnav">
                ...
                <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="airplay"></i><span>Admin</span></a>
                  ...
                  <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="inbox"></i><span>Schedule</span></a>
                    <ul class="nav-submenu menu-content">
                        <li> <a href="{{ route('schedule.index') }}">schedule</a></li>

                        <li> <a href="{{ route('schedule.create') }}">schedule Create</a></li>

                    </ul>
                  </li>
                  <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="inbox"></i><span>Section</span></a>
                    <ul class="nav-submenu menu-content">
                        <li> <a href="{{ route('section.index') }}">Section List</a></li>
                        <li> <a href="{{ route('section.create') }}">section Create</a></li>
                  ...
                  <li class="dropdown"><a class="nav-link menu-title link-nav" href="/section/join" ><i data-feather="file-text"></i><span>join section</span></a></li>
                  <li class="sidebar-main-title">
                   <hr>
                  </li>
